...
Original file is located at
    https://colab.research.google.com/drive/1gJpZN93bygD-T7SIqd-ia-tgOFuP-GIE
...
all_classes_names = os.listdir('v_ApplyEyeMakeup_g01_c02')
...
for counter, random_index in enumerate(random_range, 1):
    ...
    video_files_names_list = os.listdir(f'v_ApplyEyeMakeup_g01_c02/{selected_class_Name}')

    # Randomly select a video file from the list retrieved from the randomly selected Class Directory.
    selected_video_file_name = random.choice(video_files_names_list)

    # Initialize a VideoCapture object to read from the video File.
    video_reader = cv2.VideoCapture(f'v_ApplyEyeMakeup_g01_c02/{selected_class_Name}/{selected_video_file_name}')
